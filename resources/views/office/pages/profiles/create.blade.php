                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text"
                                        ...
                                        name="email" placeholder="ป้อนที่อยู่อีเมล" value="{{old('email')}}">
                                    <span
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control {{ $errors->has('gender') ? 'is-invalid' :'' }}"
                                        ...
                                        <option value="3">เพศที่สาม</option>
                                    </select>
                                    <span
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('address') ? 'is-invalid' :'' }}"
                                    id="address" name="address" placeholder="ป้อนที่อยู่" value="{{old('address')}}">
                                <span
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <center><img src="{{asset('assets/images/no_avatar.jpg')}}" id="output"
